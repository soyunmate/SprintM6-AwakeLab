...
Este proyecto es la Evaluación Final del Módulo de Desarrollo de aplicaciones web dinámicas con Java. El objetivo es desarrollar una solución tecnológica para una empresa de asesorías en prevención de riesgos laborales. El sistema de información permitirá administrar los principales procesos que se llevan a cabo en la empresa, como la planificación y control de actividades, gestión de clientes, coordinación con profesionales y generación de reportes. Se utilizará el patrón de diseño MVC (Modelo-Vista-Controlador) para el desarrollo de la aplicación web dinámica.

Contenido del Repositorio:
- Carpeta "src": Contiene el código fuente del proyecto Java, incluyendo los servlets y controladores necesarios.
- Carpeta "sql": Contiene el archivo SQL con el modelo de datos utilizado en la solución.
